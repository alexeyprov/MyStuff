...
void Game::Init( HWND hwndParent )
{
	...
	m_wsMy.Create(hwndParent, rect1, "Workspace", WS_CHILD | WS_BORDER | WS_VISIBLE);
	m_wsEnemy.Create(hwndParent, rect2, "Workspace", WS_CHILD | WS_BORDER | WS_VISIBLE);
