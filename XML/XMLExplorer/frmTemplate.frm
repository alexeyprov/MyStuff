   ...
   Begin ComctlLib.TabStrip tbsOptions 
      ...
      BeginProperty Tabs {0713E432-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty Tab1 {0713F341-850A-101B-AFC0-4210102A8DA7} 
            Caption         =   "General"
            Object.Tag             =   ""
            Object.ToolTipText     =   "Write the template"
            ImageVarType    =   2
         EndProperty
      EndProperty
...
Private Sub SaveTemplate()
    ...
    If Len(txtFolder) > 0 Then
        CreateDirectory STDBASEPATH + txtFolder.Text, 0
    Else
        Beep
        Exit Sub
    End If
    ...
    sTemplate = STDBASEPATH + txtFolder.Text + "\template.xmt"
    Open sTemplate For Output As #1
    Print #1, txtTemplate.Text
    Close #1
End Sub
