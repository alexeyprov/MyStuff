...
void CPopDlg::OnButton1() 
{
	...
	WCHAR  chClsid[] = L"{C910B122-A6E9-498B-A662-1EA7D26AF4E2}";
    CLSID clsid;
    HRESULT hr = CLSIDFromString(chClsid, &clsid);

	WCHAR  chClsid2[] = L"{17137C98-D54C-4C76-ADF6-7491D037F086}";
    CLSID clsid2;
    hr = CLSIDFromString(chClsid2, &clsid2);
	
	hr = ::CoCreateInstance(clsid, NULL, 
		CLSCTX_INPROC_SERVER , clsid2, (LPVOID*)&pSum);
