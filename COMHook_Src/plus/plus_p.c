...
/* Object interface: ISum, ver. 0.0,
   GUID={0x17137C98,0xD54C,0x4C76,{0xAD,0xF6,0x74,0x91,0xD0,0x37,0xF0,0x86}} */
...
CINTERFACE_PROXY_VTABLE(6) _ISumProxyVtbl = 
{
    &ISum_ProxyInfo,
    &IID_ISum,
...
const CInterfaceProxyVtbl * _plus_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISumProxyVtbl,
    0
};

const CInterfaceStubVtbl * _plus_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISumStubVtbl,
    0
};

PCInterfaceName const _plus_InterfaceNamesList[] = 
{
    "ISum",
    0
};
...
#define _plus_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _plus, pIID, n)

int __stdcall _plus_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_plus_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo plus_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _plus_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _plus_StubVtblList,
    (const PCInterfaceName * ) & _plus_InterfaceNamesList,
    0, // no delegation
    & _plus_IID_Lookup, 
    1,
    2,
