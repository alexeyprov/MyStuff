...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in Edit.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////

AppWizard creates one document type and one view:

EditDoc.h, EditDoc.cpp - the document
    These files contain your CEditDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CEditDoc::Serialize).

EditView.h, EditView.cpp - the view of the document
    These files contain your CMyEditView class.
    CMyEditView objects are used to view CEditDoc objects.
...
CntrItem.h, CntrItem.cpp - this class is used to
	...
	CMyEditView class and serialized as part of your CEditDoc class.
