...
BOOL CVCTestApp::InitInstance()
{
	...
	LCID lcOld = ::GetThreadLocale();
	LCID lcRussian = MAKELCID(MAKELANGID(LANG_RUSSIAN, SUBLANG_DEFAULT), SORT_DEFAULT);
	::SetThreadLocale(lcRussian);

	ASSERT(::GetThreadLocale() == lcRussian);
	TRACE(_T("Thread locales (old=%#x, new=%#x)\n"), lcOld, lcRussian);
